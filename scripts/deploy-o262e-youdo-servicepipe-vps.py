#!/usr/bin/env python3
"""O262e: ServicePipe challenge wait + fast-fail on youdo listing fetch."""
...
def _verify_remote() -> str:
    remote = r"""
grep 'fetch:youdo stage=servicepipe' /opt/rawlead/data/radar_site.log | tail -5 || echo 'no servicepipe logs yet'
...
def main() -> int:
    ...
    _patch_env_key("YOUDO_SERVICEPIPE_WAIT_SEC", "30")
    ssh.run("systemctl restart rawlead-radar")
