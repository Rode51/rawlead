#!/usr/bin/env python3
"""O262c: YouDo list-view wait after goto + second pass retry."""
...
def main() -> int:
    for key, val in (
        ...
        if not _patch_env_key(key, val):
            ...
            return 1
    print("env: O262c list-view vars ok")
    ...
    if not ok:
        ...
        return 1
    print("OK — O262c deployed (grep stage=list_view html_len pass after YouDo cycles)")
    return 0
