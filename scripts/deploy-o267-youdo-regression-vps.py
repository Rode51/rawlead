#!/usr/bin/env python3
"""O267: YouDo persistent profile + soft ServicePipe fail — deploy worker + src, restart radar."""
...
grep 'servicepipe_skip_ban' /opt/rawlead/data/radar_site.log | tail -5
"""
...
def main() -> int:
    for key, val in (
        ...
        if not _patch_env_key(key, val):
            ...
            return 1
    print("env: O267 regression vars ok")
    ...
    if not ok:
        ...
        return 1
    print("OK — O267 YouDo regression deployed")
    return 0
