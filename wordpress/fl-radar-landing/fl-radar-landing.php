<?php
/**
 * Plugin Name: FL Radar Landing
 * Description: Скелет страниц FL Radar (Local): home, how, pricing, faq, contact + меню.
 * Version: 0.2.0
 * Author: FL Radar
 * Text Domain: fl-radar-landing
 */
...
final class FL_Radar_Landing {
    ...
    private static function load_content(string $slug): string {
        ...
        return '<p>Контент: docs/ops/wp-skeleton/' . esc_html($slug) . '.md</p>';
    }
    ...
    public static function admin_notice(): void {
        ...
        if ($missing === []) {
            echo '<div class="notice notice-success"><p><strong>FL Radar Landing:</strong> скелет (5 страниц) на месте.</p></div>';
            return;
        }
        echo '<div class="notice notice-warning"><p><strong>FL Radar Landing:</strong> нет страниц: '
            . implode(', ', $missing)
            . '. Деактивируй и снова активируй плагин.</p></div>';
    }
}

FL_Radar_Landing::init();
