...
$cards = [
    ...
    [
        ...
        'text'  => __('Таргет, SEO, SMM, воронки — ИИ убирает нерелевантное до того, как ты открыл ленту.', 'rawlead-kadence-child'),
        'tags'  => __('таргет · SEO · SMM · контекст', 'rawlead-kadence-child'),
    ],
    [
        'title' => __('Тексты & Переводы', 'rawlead-kadence-child'),
        'text'  => __('Копирайтинг, локализация, редактура — только заказы под твой профиль.', 'rawlead-kadence-child'),
