...
## Карта (5 IP) — **2026-06-01**

**Секреты только в `.env` / VPS.** Формат: `http://host:port:user:pass`

| IP:port | Закреплён за | В FL/Kwork pool? |
|---------|--------------|------------------|
| **45.152.197.25:8000** | `TG_PROXY_URL` · **acc1** Telethon | **нет** — бот + acc1 |
| **38.154.16.60:8000** | **acc2** Telethon | **да** — запасной в ротации |
| **168.90.199.99:8000** | **acc3** (+ acc4 spare) | **да** — запасной в ротации |
| **212.102.151.153:8000** | — | **да** — основной биржевой |
| **185.147.131.15:8000** | — | **да** — основной биржевой |
