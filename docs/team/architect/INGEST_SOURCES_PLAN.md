...
| **O63** | YouDo | Запрос владельца 2026-05-30 |
| **O63** | Freelance.ru | Был P2 · поднять в волну |
| **O63** | FreelanceJob | Запрос владельца · URL при ТЗ |
| **O63** | Пчёл.нет (`pchyol`) | Запрос владельца · URL при ТЗ |

**Gate O63:** после O37-UX green · волна **4 парсера** одним ТЗ · не смешивать с pre-prod.
...
_Lead Architect · O63 · 2026-05-30_
