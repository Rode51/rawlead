...
| **5** | **Копирайт прод** — без closed beta | **@lead-product** (E4) → @coder | Нет «закрытое тестирование», «оставьте заявку», «ранний доступ» на FAQ/контактах/тарифе · [`LEAD_PRODUCT_PROMPT.md`](../product/LEAD_PRODUCT_PROMPT.md) § PRE-LAUNCH-UX c4 |
