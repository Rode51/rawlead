...
Выбирай 3-7 ключевых навыков под текущий тип заказов. Если выбрать слишком много чипов и нажать "Применить", лента сузится до заказов с пересечением по выбранным тегам, и часть релевантных лидов может скрыться. Оптимальный режим: 1-2 специализации + небольшой набор Tier A навыков, а Tier B включать точечно.
...
| Показать еще | Расширенный список Tier B навыков |
