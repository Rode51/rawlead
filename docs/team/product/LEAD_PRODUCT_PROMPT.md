...
**→ Статус:** **§ O105-COPY — ✅ PM approve (2026-06-03)** · O96 ✅ prod · Design → Coder ожидает
...
| Tooltip слотов | **«На один заказ — ограниченное число персональных откликов. Когда места кончились — заказ уходит из ленты.»** |
...
| `/faq/` **NEW** Q8 | «Почему лимит 10 откликов на заказ?» | **«Чтобы на один hot-заказ не съехалась толпа одинаковых ботов. Каждый отклик — свой. Когда слоты кончились, заказ исчезает из ленты — бери другой матч.»** |
