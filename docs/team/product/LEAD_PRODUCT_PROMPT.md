...
**→ Сейчас @lead-product:** **§ SITE-POLISH copy** — тексты на [rawlead.ru](https://rawlead.ru): лента, кабинет, вход, тариф (без «ранний доступ»). Stress отложен. Сверка c1–c4 из § E4.
...
| Показать редкие | «Показать редкие навыки» |
