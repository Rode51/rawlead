...
Версия: **0.9.3** · Lead Product + владелец · 2026-05-25 (ICP + §0h)
...
**Аудитория:** **все фрилансеры** (дизайн, копирайт, маркетинг, разработка, SMM, переводы, …) — **не только IT**. Владелец на вайбкодинге = первый dogfood, не ограничение продукта.
...
| **3f ИИ-агент** | → следующий код | рыночная цена + черновик отклика + push TG |
...
**Под ставку B (2026-05-25):** **3b–3d ✅** · лента бот-only ✅ · **волна 2** (UX/копирайт) · **3f ИИ-агент** · TG Login + **3h биллинг**. ROADMAP — `@lead-architect`.
