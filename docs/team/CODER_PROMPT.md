...
**Вариант A (предпочтительно):** владелец кладёт экспорт в  
`docs/ops/TG_CHANNELS_EXPORT.txt` — по одной ссылке или `название;https://t.me/...` на строку.

**Вариант B:** Coder вручную из Google Doc (если владелец дал доступ / вставил в EXPORT).

Если EXPORT пуст — в STATUS написать: «нужен `TG_CHANNELS_EXPORT.txt` от владельца», не выдумывать ссылки.
